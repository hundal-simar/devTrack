    ...
    <div className="flex flex-col gap-5 mx-auto max-w-4xl justify-center">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          ...
          <p className="text-2xl font-semibold text-gray-800">{totalSolved}</p>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          ...
          <p className="text-2xl font-semibold text-gray-800">{formatDuration(todayTotal)}</p>
      ...
      <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex flex-wrap gap-1">
            {calendarDays.map(day => (
              <div
                key={day.date}
                title={day.date}
                className={`w-4 h-4 rounded-sm cursor-default transition-colors ${squareStyleLocal(day)}`}
              />
            ))}
          </div>
        </div>
        ...
        {/* Weekly bar chart */}
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          <h2 className="text-sm font-medium text-gray-700 mb-4">Study time this week</h2>
          ...
          {goals.length === 0 ? (
            ...
            <div className="flex flex-col gap-0">
              {goals.slice(0, 5).map(goal => (
                <div key={goal.id} className="flex items-center gap-3 py-2.5 border-b border-gray-50 last:border-b-0">
          ...
          {recentFour.length === 0 ? (
            ...
            <div className="flex flex-col">
              {recentFour.map(problem => (
                <div key={problem.id} className="flex items-center justify-between py-2.5 border-b border-gray-50 last:border-b-0">
                  <div>
                    <p className="text-sm text-gray-700 font-medium">{problem.name}</p>
